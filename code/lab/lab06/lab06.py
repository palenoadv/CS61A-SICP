...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        if self.transactions:
            ...
            self.transactions.append(Transaction(self.id, 0, amount))
        self.id += 1
...
class Server:
    ...
    def send(self, email):
        ...
        """
        self.clients.inbox.append(email)
...
class Coin:
    ...
    def worth(self):
        return self.cents if Mint.present_year - self.year <= 50 else self.cents + Mint.present_year - self.year - 50
